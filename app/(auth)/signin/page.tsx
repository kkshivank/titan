        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-sm mx-auto">
            ...
            <form>
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
                  ...
                  <input id="email" type="email" className="form-input w-full text-gray-700" placeholder="you@yourcompany.com" required />
                </div>
              </div>
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
                  <label className="block text-gray-700 text-sm font-medium mb-1" htmlFor="password">Password</label>
                  <input id="password" type="password" className="form-input w-full text-gray-700" placeholder="Password (at least 10 characters)" required />
                </div>
              </div>
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
                  <div className="flex justify-between">
                    <label className="flex items-center">
                      ...
                      <span className="text-gray-900 ml-2">Keep me signed in</span>
                    </label>
            ...
            <div className="text-gray-800 text-center mt-6">
              Don’t you have an account? <Link href="/signup" className="text-purple-600 hover:underline hover:text-purple-900 transition duration-150 ease-in-out">Sign up</Link>
            </div>
          </div>
