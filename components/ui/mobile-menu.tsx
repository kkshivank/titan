    ...
    <div className="md:hidden">
      ...
      >
        <ul className="bg-gray-800 px-4 py-2">
          <li>
            <Link href="https://blogpage-arya.vercel.app/" className="flex font-medium w-full text-purple-600 hover:text-gray-200 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>
              Blogs
            </Link>
          </li>
          <li>
